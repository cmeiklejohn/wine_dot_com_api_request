...
Gem::Specification.new do |s|
  ...
  s.email = %q{cmeik@mac.com}
  s.extra_rdoc_files = ["README.rdoc", "lib/wine_dot_com_api_request.rb"]
  s.files = ["README.rdoc", "Rakefile", "lib/wine_dot_com_api_request.rb", "Manifest", "wine_dot_com_api_request.gemspec"]
